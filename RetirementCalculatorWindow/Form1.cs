...
namespace RetirementCalculatorWindow
{
    ...
    public partial class Form1 : Form
    {
        ...
        /*code for validation provided by https://www.youtube.com/watch?v=l68j38ie1_k */

        private void currentAge_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (char.IsDigit(e.KeyChar) == false && char.IsControl(e.KeyChar) == false 
                && (e.KeyChar == '.' ? currentAge.Text.Contains(".") == true: true)) 
            e.Handled = true; 
        }
        ...
        {
            if (char.IsDigit(e.KeyChar) == false && char.IsControl(e.KeyChar) == false 
                && (e.KeyChar == '.' ? retirementAge.Text.Contains(".") == true : true))
                e.Handled = true;
        }
        ...
        {
            if (char.IsDigit(e.KeyChar) == false && char.IsControl(e.KeyChar) == false 
                && (e.KeyChar == '.' ? annualIncome.Text.Contains(".") == true : true))
                e.Handled = true;
        }
        ...
        {
            if (char.IsDigit(e.KeyChar) == false && char.IsControl(e.KeyChar) == false 
                && (e.KeyChar == '.' ? yearsToLive.Text.Contains(".") == true : true))
                e.Handled = true;
        }
